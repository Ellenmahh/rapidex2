!function($, wysi) {
	...
	var templates = {
		...
		"link": 	"<li>" 
						...
						+ "<div class='bootstrap-wysihtml5-insert-link-modal hide' style='background: #FFF; border: solid 1px;'>"
	...
	Wysihtml5.prototype = {
		...
		initInsertLink: function(toolbar) {
			...
			urlInput.keypress(function(e) {
				if(e.which == 13) {
					insertLink();
					insertLinkModal.toggleClass('hide');
				}
			});
			...
			toolbar.find('a[data-dismiss=modal]').click(function() {
				insertLinkModal.toggleClass('hide');
			});
		}
	};
