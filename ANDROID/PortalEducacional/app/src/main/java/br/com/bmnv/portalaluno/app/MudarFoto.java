...
public class MudarFoto extends AppCompatActivity implements View.OnClickListener {



    public static final String UPLOAD_URL = "http://outsidethebx.com.br/portaleducacional/upload.php";
    ...
    private ImageView buttonChoose, image_user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mudar_foto);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        LayoutInflater inflater;
        context = this;
        image_user = (ImageView)findViewById(R.id.imageView);
    ...
    private void uploadImage(){
        ...
        class UploadImage extends AsyncTask<Bitmap,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(MudarFoto.this, "Salvando foto...", null,true,true);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                Intent intent = new Intent(MudarFoto.this, HomeActivity.class);
